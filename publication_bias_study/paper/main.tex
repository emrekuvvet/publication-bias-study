...
directional findings; concerns about significance-sorting in this specific
corpus do not find empirical support.  For journal editors, the results are
consistent with a selection process that rewards identification quality over
finding direction, which may constitute a desirable editorial norm for
