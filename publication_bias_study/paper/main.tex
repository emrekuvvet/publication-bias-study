...
likely to overstate than understate any premium.  Our human-validation
...
available at \texttt{\url{https://github.com/emrekuvvet/publication-bias-study}}.  The repository
contains:
...
\item \texttt{validation/human\_coding\_sheet\_40.xlsx} --- Coding sheet for
  40-paper human direction-coding validation
