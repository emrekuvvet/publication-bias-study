...
only robust predictor of top-journal publication is a quasi-experimental
identification strategy (coefficient $0.467^{***}$, s.e.\ 0.157, $\approx$18 pp
premium).  The joint pattern indicates that editorial selection is directionally
...
corpus (29.4\% vs.\ 19.9\% for NBER) reflects the typeset formatting of some
