...
The two samples are largely non-overlapping cross-sections (only
$\approx$12\% overlap), so comparisons reflect differences between distinct
populations, not papers tracked through the editorial filter; for the full
discussion of identification limitations and their implications, see
...
The full treatment of these identification constraints---including the direction of likely bias and what the design can and cannot establish---is consolidated in Section~\ref{subsec:limitations}.
