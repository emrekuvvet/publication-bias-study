%% ============================================================
%%  Editorial Neutrality and Revision-Stage Pressure in Top Finance Journals:
%%  Evidence from Government Intervention Research
%%
...
%% ---- Title block --------------------------------------------
\title{Editorial Neutrality and Revision-Stage Pressure in Top Finance Journals:\\
       Evidence from Government Intervention Research%
...
it is concentrated in the published record and absent from pre-publication
counterparts, consistent with revision-stage pressure.

As supporting context, a cross-sectional comparison of publication rates across
134 top-journal articles and 157 NBER working papers (2000--2024) finds no
significant difference by finding direction: positive-finding papers appear in
the \JF{}, \RFS{}, or \JFE{} at 45.6\%, negative-finding at 46.1\%, and
null-finding at 46.7\% ($p = 0.992$); a binary directional probit coefficient
is $-0.020$ (s.e.\ 0.182, $p = 0.91$), robust across six specifications.  The
strongest predictor of top-journal publication is a quasi-experimental
identification strategy (coefficient $0.467^{***}$, s.e.\ 0.157, $\approx$18 pp
premium; this coding has not been independently validated at the granular level).  The joint pattern indicates that editorial selection is directionally
neutral while the revision process creates within-paper threshold pressure
concentrated in anti-intervention findings.
\end{singlespace}
\vspace{4pt}
...
design cannot rule this out.  The editorial gate does not discriminate by
direction, but the revision process appears to create a conditional threshold
premium for anti-intervention findings.
