...
First, only 16 of 134 published papers (11.9\%) can be matched to a specific
NBER counterpart, so we are comparing two largely non-overlapping groups of
papers rather than tracking the same paper through the editorial process.
