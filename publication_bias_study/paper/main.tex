...
the \JF{}, \RFS{}, and \JFE{} reveals significant threshold bunching just below
$|z|=1.96$ (caliper ratio $1.20$; naive $p = 0.002$; paper-level permutation
$p = 0.001$), whereas the identical pipeline applied to 8,351 test statistics
from 157 NBER working papers on the same topic finds no bunching at all (ratio
...
full-sample threshold bunching (caliper ratio $= 1.20$; naive $p = 0.002$;
paper-level permutation $p = 0.001$), concentrated in \JFE{} (caliper ratio
$= 1.49$, $p < 0.001$) and strikingly asymmetric by direction:
