...
record (\citealt{Brodeur2016} caliper ratio $= 1.20$; naive $p = 0.002$;
paper-level permutation $p = 0.001$), but this bunching is entirely absent from
the pre-publication NBER benchmark (ratio $= 1.01$, $p = 0.849$).  The contrast
is sharpest for negative-finding papers: published caliper ratio $1.52$
(permutation $p < 0.001$; cluster-bootstrap 95\% CI $[0.81, 2.67]$) versus
NBER ratio $1.00$ ($p = 0.964$).  Because the overall significance rates are nearly identical across
...
threshold pressure concentrated in anti-intervention findings (negative-finding
caliper ratio 1.52; permutation $p<0.001$; cluster-bootstrap 95\% CI
$[0.81,\,2.67]$---wide, reflecting paper-level heterogeneity).
\end{singlespace}
\vspace{4pt}
