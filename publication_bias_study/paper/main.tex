...
across five areas: sensitivity of the caliper test to the choice of window,
sample and scope restrictions, alternative model specifications, concerns
about classification quality, and an alternative pre-publication baseline.
...
six model specifications.  The design rules out gaps larger than 18 percentage
...
(31.6\% vs.\ 21.0\% in NBER papers).  The bunching is most pronounced in
