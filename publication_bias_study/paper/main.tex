...
terms, and main-result variables.  A potential concern is that pooling all
table statistics --- including controls --- could confound the direction-based
caliper comparison, since a negative-finding paper's tables contain many
statistics unrelated to its headline finding.

The non-control subsample retains 7,055 published statistics (90.9\% of
the full sample) and 7,599 NBER statistics (91.0\%), distributed across
108 published and 104 NBER papers.  Caliper ratios and $p$-values are essentially
