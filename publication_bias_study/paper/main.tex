...
Both concerns pull in the same direction: either mechanism would push genuinely
directional NBER papers into the null category, inflating the measured directional
premium.  Our replication exercise (Section~\ref{subsec:direction}) supports
