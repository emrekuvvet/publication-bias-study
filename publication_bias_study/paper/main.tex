...
papers, consistent with within-paper specification pressure concentrated at the
revision stage---though compositional differences between the two corpora
cannot be ruled out.  Note that the NBER and journal samples are largely
...
The strongest predictor of top-journal publication in our sample is the use
...
to the revision stage rather than to the upstream research design.  We are not
