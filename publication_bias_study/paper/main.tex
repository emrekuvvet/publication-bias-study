...
available at \url{https://github.com/emrekuvvet/publication-bias-study}.  The repository
contains:
...
\label{app:replication_by_source}
%% ============================================================

Table~\ref{tab:replication_by_source} disaggregates the LLM replication agreement
...
\label{tab:replication_by_source}
\begin{singlespace}
...
replication: claude-haiku-4-5-20251001).
\end{minipage}
\end{singlespace}
\end{table}
